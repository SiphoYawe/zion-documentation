...
<CardGroup cols={2}>
  ...
  <Card title="At-Risk Students" icon="triangle-exclamation" href="/guides/supervisor/interventions">
    Strategies for supporting struggling students identified in alerts
  </Card>
