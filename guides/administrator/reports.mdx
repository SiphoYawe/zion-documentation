...
<Frame caption="The reports index listing report types available across the school">
  <img src="/images/guides/administrator/reports-1.png" alt="Zion reports page listing Goal Check, attendance, grading, and report card outputs" />
</Frame>
...
<Frame caption="Generating a daily centre report with the readiness indicator showing every student marked">
  <img src="/images/guides/administrator/reports-2-generate.png" alt="Zion report generation screen with centre, date, and readiness indicator" />
</Frame>
