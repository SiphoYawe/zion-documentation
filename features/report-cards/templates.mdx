...
<Frame caption="The template builder with the school logo and section order controls.">
  <img src="/images/features/report-cards/templates-1.png" alt="Report card template builder showing logo upload and section ordering controls" />
</Frame>
