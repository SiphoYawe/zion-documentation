...
<Frame caption="Overdue and lost flags on the active checkouts list">
  <img src="/images/features/library/checkouts-1.png" alt="An active checkouts list with overdue and lost status flags on individual rows" />
</Frame>
