...
<Frame caption="The alert threshold settings page with default values for each alert type.">
  <img src="/images/features/school-settings/alerts-1.png" alt="Alert threshold settings page listing default values for each alert type" />
</Frame>
...
<Frame caption="The weekly report settings page with schedule and recipient list controls.">
  <img src="/images/features/school-settings/weekly-reports-1.png" alt="Weekly report settings page showing schedule and recipient list controls" />
</Frame>
