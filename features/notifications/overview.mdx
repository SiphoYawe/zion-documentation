...
<Frame caption="The notification history page grouped by date">
  <img src="/images/features/notifications/overview-1.png" alt="A list of notifications grouped by date with read and unread states" />
</Frame>
