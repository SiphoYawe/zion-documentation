...
<Frame caption="Managing the activity catalog with create, edit, and archive actions">
  <img src="/images/features/extracurriculars/catalog-1.png" alt="A staff view of the activity catalog with options to create, edit, and archive activities" />
</Frame>
