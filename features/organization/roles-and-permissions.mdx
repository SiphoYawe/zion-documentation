...
<Frame caption="The roles and permissions catalog grouped by area, with keys grantable to custom roles.">
  <img src="/images/features/organization/roles-1.png" alt="Roles and permissions catalog showing permission keys grouped by area" />
</Frame>
