...
<Frame caption="The academic terms list with the current term marked.">
  <img src="/images/guides/administrator/school-management-1-terms.png" alt="Academic terms list showing start date, end date, and current term flag" />
</Frame>
