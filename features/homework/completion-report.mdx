...
<Frame caption="The homework completion report with KPI cards and a per-student table.">
  <img src="/images/features/homework/completion-report-1.png" alt="Homework completion report with assigned, verified, and missed counts" />
</Frame>
