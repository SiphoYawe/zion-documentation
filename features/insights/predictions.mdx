...
<Frame caption="The predictions dashboard with a status donut chart and searchable, filterable student cards.">
  <img src="/images/guides/administrator/insights-2-predictions.png" alt="Predictions dashboard showing on track, at risk, and off track student status" />
</Frame>
